                    ...
                    <div className="container flex justify-between space-x-4 lg:space-x-16 items-start">
                        ...
                        <nav className="hidden md:flex lg:flex justify-between flex-1 pl-10">
                            <div className="flex items-center lg:text-md space-x-2 lg:space-x-8 drop-shadow-xl text-white">
                                <a href="https://www.base.org" target="_blank" className="hover:text-gega-sky transition duration-500 tracking-widest"><i className="fa-brands fa-hive"></i> Base</a>
                                <a href="https://www.base.org/build" target="_blank" className="hover:text-gega-sky transition duration-500 tracking-widest text-blue-500"><i className="fa-solid fa-faucet"></i> Base Build</a>
                    ...
                    <header id="menubar" className={`${menuBarActive ? "text-white font-gemunu uppercase change pt-2" : "text-white font-gemunu uppercase hidden pt-2"}`}>
                        <nav className="">
                            <div className="flex flex-col items-end space-y-1 pr-2">
                                <a href="https://www.base.org" target="_blank" className="hover:text-gega-melon transition duration-500 tracking-widest"><i className="fa-brands fa-hive"></i> Base</a>
                                <a href="https://www.base.org/build" target="_blank" className="hover:text-gega-melon transition duration-500 tracking-widest"><i className="fa-solid fa-faucet"></i> Base Build</a>
